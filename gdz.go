...
func main() {
	...
	log.Println("Стадия фильтрации отрицательных чисел")
	...
	log.Println("Стадия фильтрации кратных 3")
	...
	// стадия буферизации
	log.Println("Стадия буферизации")
